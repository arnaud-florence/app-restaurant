    ...
    <div className="max-w-7xl mx-auto p-4 space-y-6">
      <header>
        <h1 className="text-2xl font-bold flex items-center gap-2">
          ...
          Capacité par zone (commandes en ligne)
        </h1>
        <p className="text-sm text-zinc-500">
          Limite anti-rush : nombre max de commandes ONLINE acceptées par créneau, <strong>par cuisine</strong>.
          Snacking / Pizza / Bar ont chacun leur capacité indépendante.
        </p>
      </header>
