// Applique la migration 0120 (mode encaissement) via la fonction PG
...
const BAK = 'backups/recettes-avant-0120.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0120_mode_encaissement.sql', 'utf8')
...
console.log('✓ migration 0120 appliquée —', JSON.stringify(data))
