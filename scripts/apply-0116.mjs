// Applique la migration 0116 (type de notif) via la fonction PG
...
const BAK = 'backups/fournil-avant-0116.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0116_notif_commande_online.sql', 'utf8')
...
console.log('✓ migration 0116 appliquée —', JSON.stringify(data))
