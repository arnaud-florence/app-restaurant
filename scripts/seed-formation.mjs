...
const QUIZ = {
  ...
  livreur: [
    { q: "À quel moment cliquer 'En route' dans /livreur ?",
      choix: ["Quand la cuisine commence", "Quand tu as le sachet dans tes mains", "Avant de partir au resto", "Après livraison"],
      bonne: 1, ex: "Avec le sachet en main = pas d'oubli. Cliquer trop tôt = risque d'oublier le sachet en cuisine." },
    ...
    { q: "À quel moment marquer 'Livré' dans l'app ?",
      choix: ["En rentrant au resto", "Immédiatement après avoir remis le sachet", "Plus tard, quand tu as le temps", "Le manager le fait"],
      bonne: 1, ex: "Immédiatement = source unique de vérité. Le manager voit la tournée en temps réel." },
    { q: "Le client refuse la livraison (mauvais plat). Que fais-tu ?",
      choix: ["Tu insistes", "Tu reprends le sachet + tu préviens le manager via /equipes", "Tu marques 'Livré' quand même", "Tu jettes le sachet"],
      bonne: 1, ex: "Sachet repris + manager informé. Lui décide du geste commercial (re-livraison, remboursement)." },
    ...
    { q: "Tu es en retard de 20 min sur le créneau. Premier réflexe ?",
      choix: ["Tu te dépêches sans rien dire", "Tu appelles le client pour le prévenir", "Tu marques 'Livré' à l'avance", "Tu attends d'arriver"],
      bonne: 1, ex: "Communication AVANT le retard = client conciliant. Sans appel = avis négatif quasi-garanti." },
    ...
    { q: "Tu rentres au resto, ta tournée est finie. Que vérifies-tu sur /livreur ?",
      choix: ["Rien", "Toutes les commandes du jour au statut 'livre' ou explicite (refusee/non_livree)", "Tu ferme l'app", "Tu vas voir le manager"],
      bonne: 1, ex: "Clôture propre = pas de commande en 'en_livraison' fantôme. Sinon le manager te relance demain." },
  ],
}
