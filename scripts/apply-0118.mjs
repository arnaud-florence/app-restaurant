// Applique la migration 0118 (produits hors Fournil) via la fonction PG
...
const BAK = 'backups/recettes-avant-0118.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0118_masquer_produits_hors_fournil.sql', 'utf8')
...
console.log('✓ migration 0118 appliquée —', JSON.stringify(data))
