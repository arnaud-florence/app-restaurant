// Applique la migration 0122 (miroir caisse) via la fonction PG
...
const BAK = 'backups/recettes-avant-0122.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0122_miroir_caisse.sql', 'utf8')
...
console.log('✓ migration 0122 appliquée —', JSON.stringify(data))
