// Applique la migration 0119 (source CAISSE) via la fonction PG
...
const BAK = 'backups/recettes-avant-0119.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0119_source_caisse.sql', 'utf8')
...
console.log('✓ migration 0119 appliquée —', JSON.stringify(data))
