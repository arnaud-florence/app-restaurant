// Applique la migration 0117 (adresse) via la fonction PG
...
const BAK = 'backups/fournil-avant-0117.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0117_adresse_casatasia.sql', 'utf8')
...
console.log('✓ migration 0117 appliquée —', JSON.stringify(data))
