// Applique la migration 0123 (alignement prix) via la fonction PG
...
const BAK = 'backups/recettes-avant-0123.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0123_aligner_prix_sur_caisse.sql', 'utf8')
...
console.log('✓ migration 0123 appliquée —', JSON.stringify(data))
