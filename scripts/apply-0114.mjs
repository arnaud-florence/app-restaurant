// Applique la migration 0114 (précision du HT) via la fonction PG
...
const BAK = 'backups/fournil-avant-0114.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0114_prix_ht_precision.sql', 'utf8')
...
console.log('✓ migration 0114 appliquée —', JSON.stringify(data))
