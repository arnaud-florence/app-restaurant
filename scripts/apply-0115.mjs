// Applique la migration 0115 (commandable en ligne) via la fonction PG
...
const BAK = 'backups/fournil-avant-0115.json'
...
// ─── 2. Application ─────────────────────────────────────────────────
const sql = readFileSync('supabase/migrations/0115_fournil_commandable_en_ligne.sql', 'utf8')
...
console.log('✓ migration 0115 appliquée —', JSON.stringify(data))
